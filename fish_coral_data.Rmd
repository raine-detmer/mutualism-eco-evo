...
Ppref.N1.evo <- c(0.03056071, 0.39069991, 0.57873937) # from "model_simulations.Rmd"
Ppref.D1.evo <- c(0.02888623, 0.39186314, 0.57925063) # from "model_simulations.Rmd"
Ppref.0 <- c(0.1228871, 0.3603216, 0.5167914) # from "model_simulations.Rmd"
...
mtext(side = 1, expression(Host~size~(cm^2)), line = 2, outer = T, cex = 1.2)
