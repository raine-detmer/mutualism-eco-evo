...
mtext(side = 1, expression("Host area ("*cm^2*")"), line = 2.25)
mtext(side = 3, expression("a)"~n[H]*"(A)"), adj = 0)
mtext(side = 2, expression("Host DI mortality rate ("*month^-1*")"), line = 2.75)
...
mtext(side = 1, "Partners per host (no.)", line = 2.25)
mtext(side = 2, expression("Asymptotic host DI mortality rate ("*month^-1*")"), line = 2.75)
mtext(side = 3, expression("b)"~c[n]*"(P/H)"), adj = 0)
...
mtext(side = 2, expression("Host area ("*cm^2*")"), line = 2.75)
...
mtext(side = 1, "Partners per host (no.)", line = 2.25)
mtext(side = 2, expression("Host growth rate ("*month^-1*")"), line = 2.75)
